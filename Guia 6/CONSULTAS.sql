...
dir.linea1, dir.linea2, ciu.ciudad, est.estado, pa.pais, car.cargo
...
select * from piloto;
SELECT emp.nombre, emp.apellidos, emp.DUI, emp.celular, 
dir.linea1, dir.linea2, ciu.ciudad, est.estado, pa.pais, pil.licencia, emp.pasaporte, vis.numVisa, vis.tipo
...
inner join estado est on ciu.idEstado = est.idEstado
inner join pais pa on est.idPais = pa.idPais
inner join piloto pil on emp.idEmpleado = pil.idEmpleado
inner join visa vis on emp.idVisa = vis.idVisa;